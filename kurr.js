		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "Ws Wengi Su Melek Ae 🌚"; break;
                case 1: jamss = "Ws Wengi Su Melek Ae 🌚"; break;
                case 2: jamss = "Ws Wengi Su Melek Ae 🌚"; break;
                case 3: jamss = "Dah Mau Shubuh Siap Siap Shalat Ya 🌔"; break;
                case 4: jamss = "Dah Shubuh Jangan Lupa Shalat Kak🌔"; break;
                case 5: jamss = "Enjing 🌄"; break;
                case 6: jamss = "Ening 🌄"; break;
                case 7: jamss = "Enjing 🌄"; break;
                case 8: jamss = "Enjing ☀️"; break;
                case 9: jamss = "Enjing ☀️"; break;
                case 10: jamss = "Enjing ☀️"; break;
                case 11: jamss = "Enjing 🌞"; break;
                case 12: jamss = "Udh Dzuhur  Jangan Lupa Shalat Kak 🌞"; break;
                case 13: jamss = "Beduk 🌞"; break;
                case 14: jamss = "Beduk 🌞"; break;
                case 15: jamss = "Dah Ashar Jangan Lupa Shalat kak🌞"; break;
                case 16: jamss = "Surup ☀️"; break;
                case 17: jamss = "Surup 🌄"; break;
                case 18: jamss = "Dah Maghrib Jangan Lupa Shalat 🌄"; break;
                case 19: jamss = "Wengi 🌙"; break;
                case 20: jamss = "Wengi 🌙"; break;
                case 21: jamss = "Wengi 🌙"; break;
                case 22: jamss = "Ws Wengi Su Melek Ae 🌙"; break;
                case 23: jamss = "Ws Wengi Su Melek Ae 🌚"; break;
            }
...
if(budy.includes('Ahmadlui')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6282146092695@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('Ahmadluay')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6282146092695@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('Luay')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6282146092695@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('Lui')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6282146092695@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('Assalamualaikum')){
cpref = `Waalaikumsalam Saya  eL GM Bot wea Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('assalamualaikum')){
cpref = ` waalaikumsalam Saya  eL GM Bot wea Ketik .menu Untuk Mengakses`
...
cpref = `Hai Juga  Saya eL GM Bot Wea Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('hai')){
cpref = `Hay Juga Saya eL GM Bot Wea Ketik .menu Untuk Mengakses`
reply(cpref)
}
...
reply(String(e))
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 2500) {
        ...
        reply("ANTIVIRTEX DETECTED!! ASW PIRTEQ JNCK🤬");
        kurr.groupRemove(from, [kic]).catch((e) => { reply(`Awokwokawok`) })
            }
        }
           ...
           if (budy.includes("https://chat.whatsapp.com/","http://chat.whatsapp.com/")) {
        	if (!mek.key.fromMe){
			    ...
			    kurr.groupRemove(from, [kic]).catch((e) => { reply(`JURUS TENDANGAN GARUDA 🙀🙀`) })
			}
			}
			// MUTE
        if (isMuted){
...
return reply('😒Sabar Vanhg 5 Detik/Command')}  
...
if (isCmd && !isOwner) antiSpam.addFilter(from)
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`Hy eL GM Bot wea`).catch((_)=>_);
...
case 'ownermenu':
  if (!isOwner && !mek.key.fromMe) return reply(`KHUSUS KAUM ELITE😎`)
        if(menusimpel == false){               
                const timestampi = speed();
					const latensyi = speed() - timestampi
...
_書 ${prefix}nano [ _nama file_ ]_             
 `
sendButLocation(from, `${menu}`, "*_© eL GM_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'blmmenu':
     ...
     get_result = ini_result.result
       ...
       menu = `*─❒ BIKIN LAG MENU (khusus elite)*
_書 ${prefix}piltek_
_書 ${prefix}gift_               
 `
sendButLocation(from, `${menu}`, "*_© eL GM_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
...
{buttonId:`allmenu`,buttonText:{displayText:'SHOW MENU'},type:1},
{buttonId:`store`,buttonText:{displayText:'STORE MENU'},type:1},
{buttonId:`script`,buttonText:{displayText:'FREEBOT'},type:1}
]
mhan = await kurr.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
...
case 'meme':
              ...
              buttonsMessage = {footerText:'✗✗✗ Ahmdlui', imageMessage: imageMsg,
...
FREEBOT UNTUK AKSES BOT
KETIK .freebot
DAN PILIH YANG MAU DI KLIK
ATAU MASUK KE GRUP DIBAWAH 
JIKA MAU GRATIS
JOIN GRUP
GC 1: https://chat.whatsapp.com/`
...
_ℒ⃝👨‍💻 Name Creator : AhmdLu`i_

*BOT INI FREE*
_*HUBUNGI OWNER UNTUK MEMASUKAN BOT KEDALAM GRUP*_
`
sendButLocation(from, `${menu}`, "*_© eL GM_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'FREE BOT'},type:1},{buttonId:`speed`,buttonText:{displayText:'SPEED BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
gbutsan = [
{buttonId:`allmenu`,buttonText:{displayText:'SHOW MENU'},type:1},
{buttonId:`free`,buttonText:{displayText:'FREE MENU'},type:1},
{buttonId:`script`,buttonText:{displayText:'MASUKIN BOT KE GC'},type:1}
]
mhan = await kurr.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
...
break */
 ...
 buttonText: 'LIST ',
 footerText: '*_© eL GM_*',
 description: `Ohayoo @${stod.split('@')[0]}, Silahkan Mau Pilih Apa Kak...`,
 sections: [
                     {
 ...
 rows: [
                          {
                              "title": "FREEBOT",
                              "description": 'CLICK HERE FOR MASUKIN KE GRUP',
                              "rowId": ""
...
//Sampai sini
case 'jadibot':
    reply(`MAU JADIBOT? CHAT OWNER BOT AJ KETIK .owner LALU CHAT BISA SET BOT SMAUMU LO`)
    break
    case 'order':
...
SILAHKAN KLIK LANJUT
 `
sendButLocation(from, `${menu}`, "*_© FREE BOT ゑ_*", {jpegThumbnail:store1,name:""}, [{buttonId:`pay`,buttonText:{displayText:'LANJUT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
...
Baca artikel detiknews, "Surat Al-Isra Ayat 32, Tentang Larangan Mendekati Zina"`
  if (!isOwner && !mek.key.fromMe) return reply(ini_txt)
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=${lolkey}`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Ahmlui', imageMessage: imageMsg,
              contentText:`Nih Om`,buttons,headerType:4}
              prep = await kurr.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              kurr.relayWAMessage(prep)
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=${lolkey}&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Follow ig : ahmdlui`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`eL GM`}, MessageType.location)
...
var nn = body.slice(9)
          ...
          if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(`Jdiin Admin Dlu Bjir🗿`)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY eL GM`)
...
break
			...
			case 'speed':
			case 'ping':
ini_txt = `eL GM Bot Merespon Dalam ${latensyi.toFixed(4)} DETIK
`
reply(ini_txt)
break
				case 'return':
...
break
 ...
 `
sendButLocation(from, `${menu}`, "*_© eL GM_*", {jpegThumbnail:ofrply3,name:""}, [{buttonId:`owner`,buttonText:{displayText:'OWNER THIS BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer eL GM",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6281220670449"}}})
	}
    }
    }
    }
